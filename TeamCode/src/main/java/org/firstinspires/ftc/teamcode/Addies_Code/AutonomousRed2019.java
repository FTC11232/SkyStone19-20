...
@Autonomous(name = "AutoMecanum Final Red") //AutoMouse
//@Disabled
public class AutonomousRed2019 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (firstCall) {
                ...
                while (runtime.seconds() < 3.37 && opModeIsActive()) { //Go Forward
                ...
                while (runtime.seconds() < 3 && opModeIsActive()){ //Strafe Right
                ...
                while (runtime.seconds() < 0.7 && opModeIsActive()){ //Lift Down
                    newHwFile.slideDrop();
                }
                ...
                while (runtime.seconds() < 3 && opModeIsActive()){ //Go Backwards
                ...
                while (runtime.seconds() < 1.5 && opModeIsActive()){ //Strafe Left
                ...
                while (runtime.seconds() < 2.0 && opModeIsActive()){ //Strafe Left
                    newHwFile.strafeLeft();
                }
